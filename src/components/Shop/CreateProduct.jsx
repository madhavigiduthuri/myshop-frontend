...
const CreateProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    newForm.append("price", originalPrice);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <textarea
            ...
            name="description"
            value={description}
            className="mt-2 appearance-none block w-full pt-2 px-3 h-[150px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
          ...
          <div className="w-full flex items-center flex-wrap">
            ...
            {images &&
              images.map((eachImg, index) => (
                <img
                  src={URL.createObjectURL(eachImg)}
                  key={index}
                  alt={index}
