const styles = {
  ...
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#32a850]",
  button:
    "w-[150px] bg-[#32a850] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
